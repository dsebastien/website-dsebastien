...
slug: 'para'
categories: [pkm]
keywords: [para, the para method, introduction to para, pkm, personal knowledge management, note-taking, information management, personal organization]
published: true
---
...
The PARA method helps me to make sure I respect the _LIFT principle_, which is part of the key design principles of my PKM system.
