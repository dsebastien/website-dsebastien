...
Since I’ve published [my book about TypeScript, React, Angular and Vue](https://www.amazon.com/gp/product/B081FB89BL?pf_rd_r=F02ZS5HWMKCHHHY5N0JB&pf_rd_p=6fc81c8c-2a38-41c6-a68a-f78c79e7253f), things have continued to evolve. My chapter about React remains relevant, but the React.createElement API is [changing](https://github.com/reactjs/rfcs/blob/createlement-rfc/text/0000-create-element-changes.md).
