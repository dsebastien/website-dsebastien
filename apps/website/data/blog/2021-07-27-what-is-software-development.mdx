...
In this short article, I've introduced the notion of software development. It's just an idea, a simple *concept*. And that's the magic; if you learn the concepts one by one, then you'll quickly become one of us, a software developer. It's not that hard; it's like everything, it just takes time.
