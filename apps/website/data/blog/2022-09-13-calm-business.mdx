---
title: 'Calm businesses are a viable path too'
...
canonicalUrl: 'http://newsletter.dsebastien.net/archive/1357391'
...
<BlogPostCenteredContent>
  <Image
    alt={`A calm business is about creating a business that makes us happy`}
    src={`/static/images/blog/2022/2022-09-13-calm-business-02.png`}
    width={512}
    height={512}
    priority
  />
...
<BlogPostCenteredContent>
  <Image
    alt={`A calm business is respectful of our life. It's about removing constraints, rather than adding more`}
    src={`/static/images/blog/2022/2022-09-13-calm-business-03.png`}
    width={512}
    height={512}
    priority
  />
...
<BlogPostCenteredContent>
  <Image
    alt={`A calm business can grow and become very successful. It might take longer, but since we enjoy the journey a lot more, it's all worth it`}
    src={`/static/images/blog/2022/2022-09-13-calm-business-04.png`}
    width={512}
    height={512}
    priority
  />
