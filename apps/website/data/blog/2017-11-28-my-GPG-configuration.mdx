---
title: 'How to install and configure GPG'
summary: 'A detailed guide on how to install and configure GPG/PGP.'
publishedAt: '2017-11-28'
slug: 'my-GPG-configuration'
categories: [security, gpg, git, security]
keywords: [how to configure gpg, gpg pgp, gnupg, open pgp]
published: true
---
