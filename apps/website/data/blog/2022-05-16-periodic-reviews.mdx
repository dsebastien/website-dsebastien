...
Those notes serve two purposes. On one end, they help me uncover trends and patterns, and on the other, they act as a personal log that I can use for inspiration (e.g., to prepare [my weekly newsletter](https://newsletter.dsebastien.net)). Uncovering trends and patterns is super valuable.
