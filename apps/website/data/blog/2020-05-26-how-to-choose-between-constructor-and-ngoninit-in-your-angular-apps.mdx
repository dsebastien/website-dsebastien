...
One of my regrets with [my book about TypeScript](https://www.amazon.com/gp/product/B081FB89BL?tag=dsebastien-20) is not having dedicated more space to the strict mode of TypeScript. In retrospect, I feel like I should’ve dropped a few pages here and there to cover it more in detail, but since it hit 800 pages, my publisher was not too keen on adding more pages ;-)
