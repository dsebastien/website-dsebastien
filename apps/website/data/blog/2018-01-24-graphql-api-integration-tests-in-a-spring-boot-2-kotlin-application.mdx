...
keywords: [programming, graphql, kotlin, testing, integration tests, spring, spring boot]
---
...
* we’re using [@SpringBootTest.WebEnvironment.RANDOM\_PORT](https://spring.io/guides/gs/testing-web/). This starts the application and should bootstrap everything needed to test the back-end
