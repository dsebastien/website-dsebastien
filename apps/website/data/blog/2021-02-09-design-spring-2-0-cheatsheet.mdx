...
This isn’t an introduction to the approach, so if you’ve never heard of design sprints, you should probably check out the [Sprint](https://www.amazon.com/Sprint-Solve-Problems-Test-Ideas/dp/150112174X?tag=developassion-20) book of Jake Knapp (the creator of Design Sprints).
