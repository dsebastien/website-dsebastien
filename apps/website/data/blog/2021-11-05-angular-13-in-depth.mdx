...
In this article, I’ll go over (almost) everything noteworthy in this new release. I’ll also highlight what’s changed around Angular, like I did with my previous articles about [Angular 12](https://dsebastien.net/blog/2021-05-13-angular-12-in-depth), [Angular 11](https://dsebastien.net/blog/2020-11-15-angular-11-in-depth) and [Angular 10](https://dsebastien.net/blog/2020-07-27-angular-10-in-depth).
...
Also, a new injection token called `MAT_PROGRESS_BAR_DEFAULT_OPTIONS` has been [added to the for the progress bar](https://github.com/angular/components/pull/23363). It can be used to configure the default options as follows:
