...
summary: "How to go from an idea to a product in the making"
...
keywords: [product development, software development, jobs-to-be-done]
published: true
---
...
André and I are both Indie Hackers. We're bootstrapping products together. We try to stay lean and scrappy as we don't have the luxury of external funding. We're actually not interesting in getting funded at all. We're after sustainable growth and freedom, not growth!
...
Thank to this step, André and I have created a shared understanding of what we set out to fix/build, and we've explored potential ways to solve the issues we noticed.
...
This space is acts as our single source of truth to this project. It's the entry point to _everything_ else.
...
User Story Maps put the emphasis on user stories rather than about product features. There's some overlap, but *stories are user and goal centric, which is much more interesting for prioritization*!
...
Here's a second one: authenticated users need to go through the on-boarding process. When they do so, they first have to select a calendar to connect, and then connect the calendar. Once that is done, our app will start synchronozing contents. So that specific story has different steps.
...
André and I aren't UX or UI designers, but we have learned appreciate Figma for UX & UI work.

We started by thinking about the custmer journey from a very high level point of view:
...
This gave us a clearer view over the important aspects to focus on during our UX work. We then summarized the key characteristics:
...
At this point, we had a clear idea about how the experience would feel like, and we already had something we could show and (in)validate.
...
That's why we quickly kickstarted the [focusd community](https://join.slack.com/t/focusdgroup/shared_invite/zt-113gxeetf-kXTPA8Y9NyHVj1Wj3Rdd~A). It's not just a community for the product itself. Instead, we want it to be a space for all productivity enthusiats, whether they like/use focusd or not. We just want to help each other out and help people make better use of their most precious resource: their time ❤️.

## Wait list
As our project was not built yet, we needed a way to keep track of who was actually interested in the project. We needed to creat a wait list. The easiest option was to build a mailing list. For this, we chose to use [ConvertKit](https://convertkit.com/). They provide easy to use tools to create subscription forms, analyze the audience, send e-mails to subscribers, as well as easy to use APIs.

The wait list is critical as it is a door right to the inbox of our subscribers. Having the ability to show up in someone's mailbox is very valuable, and we didn't want to miss out on the opportunity.

The wait list will be very useful for us to share news about our progress, news about the community we're building, and to be truly open about the whole process. I consider people on the waiting list as fans, supporters, and friends! 🙏

## Social media presence
Alongside the community and mailing list, another aspect is social media marketing. Being present on social media is not really an option. I personally chose to create my own brand, but my product also needs its own space. So far we have our Twitter account, and we will later expand to reserve names on different social media platform.

Further down the road, this will give us more space to discuss with our audience, means to discover potential customers and to share news about the product.
...
## Copywriting, landing page and logo
...
Of course, the logo is just a detail compared to the sale copy. So we put a lot more effort on that front. We've combined the experience of André with [Internet wisdom](https://marketingexamples.com/) to focus on the reader, talk about benefits rather than features, providing vivid supporting details and visuals.

After the copy, we focused on creating the landing page itself. As usual, there were many options to choose from. Historically, I've always prefered to do everything by myself: the custom Wordpress theme of my long gone initial blog, my new Website's design, my company's Website, etc. The upside of doing everything myself has been the total control. But the downside is also the total control, and the opportunity it creates to endlessly fiddle with an infinite amount of details. That's how I ended up spending ten evenings to finish [DeveloPassion.be]. You read that right, ten evenings (or something close to that).
...
I'm not saying that home-made Websites are bad, but for engineers like myself, they're the perfect excuse to waste time playing with tech for tech's sake.

The current goal of that landing page is to draw more people to join the waiting list and our community. Of course, this corresponds to the top of our future sales funnel. But it's a win-win type of deal. People who join us for the ride get to hear and influence everything about the product development. On the other hand, we get to share knowledge and ideas with each other. That's what I love about audience and community building. Both are different, but both include benefits for everyone involved.
...
Spamming the link around would be ineffective, even when combined with SEO. People mostly don't care. As a matter of fact we only want the right people to care, so want to be thoughtful about who we reach out to and who we try to attract.
...
At this stage, we just want to raise awareness where it matters (e.g., on the Indie Hackers community, on productivity-centric sub-reddits, on Tech Twitter, etc). We don't plan on going all-in with content at this point. But we will ultimately get there as I enjoy writing and sharing knowledge ;-)
...
At this stage, we have the UX, the UI, interactive prototypes, a wait list, a domain, a landing page, a logo, a name, a domain. What's missing? What's next? Well, a product of course!
...
We will need to discuss about infrastructure and hosting (e.g., Docker/Kubernetes, AWS/Azure/GCP), Continuous Integration (CI), Continuous Deployment/Delivery (CD), release management, support processes, maintenance, product documentation, payments, etc.
...
## Conclusion
In this article, I've explained the different steps we've taken so far to go from an idea on a napkin to a product in the making. At this stage we have no idea if this is the way to go, but it's the way that feels good to us. And after my last startup experience, I've learned to listen to my gut feelings. And you should too!
