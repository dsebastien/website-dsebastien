---
title: 'TypeScript best practices: Interfaces and custom types vs classes'
summary: "Why you should favor TypeScript interfaces and custom types over classes."
