...
In this case, the `plainToClass` utility function would return class instances. In [my book about TypeScript](https://www.amazon.com/Learn-TypeScript-Building-Applications-understanding-ebook/dp/B081FB89BL), I’ve dedicated quite a few pages to explaining how to use those libraries.
