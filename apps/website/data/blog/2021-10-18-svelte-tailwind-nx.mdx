---
title: "Svelte, Tailwind and Nrwl NX, a powerful combo"
summary: "A tutorial explaining how to create a Svelte application using Nrwl NX and how to add Tailwind support."
publishedAt: '2021-10-18'
image: '/static/images/logos/svelte.svg'
slug: 'svelte-tailwind-nx'
categories: [tailwind, svelte, software development, programming, coding]
keywords: [tailwind, svelte, software development, programming, coding]
published: true
---
...
`npm install -D postcss-import@latest postcss-preset-env@latest node-sass`
...
The names of the script should be self-descriptive.
