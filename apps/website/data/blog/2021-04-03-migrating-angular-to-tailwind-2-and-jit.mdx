...
First, you need to upgrade to Tailwind 2.1
...
While you're at it, make sure that the `purge` option is enabled and configured properly. It should include all files that include Tailwind "rules". Here's the configuration that I'm using in my [Nrwl NX](https://nx.dev/)-based Angular application:
