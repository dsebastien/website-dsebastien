...
Over the course of his career, he developed his own mental models, techniques, and tools for learning. The Feynman technique, in particular, is based on the methods that Feynman used while studying at Princeton. James Gleick, who's behind the [biography of Richard Feynman](https://amzn.to/3SsBHdF), wrote the following:
