---
title: 'Avoiding Import Issues in TypeScript Monorepos'
summary: 'Leverage TypeScript paths to avoid problems with your imports'
publishedAt: '2020-04-18'
slug: 'avoiding-import-issues-in-typescript-monorepos'
categories: [typescript]
keywords: [typescript, path mappings, imports, modules]
published: true
---
...
## The problem with path mappings and IDE imports
