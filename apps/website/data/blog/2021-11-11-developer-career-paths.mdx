...
image: '/static/images/blog/2021/branches.jpg'
...
In summary, you'll have to be able to do a _bit of everything_. But there's no one size fits all. Some seniors and experts have actually a very narrow skillset. For instance, there are world-class experts for specific technologies (e.g., Web performance, Databases, Security, Java Virtual Machines, etc). This fits into the career development choices that we'll discuss later in the article.
