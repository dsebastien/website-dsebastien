...
summary: "The LIFT principle is a useful one to add to your information management toolkit. Here's a short introduction."
...
This principle's goal is to ensure that we keep files and folder structures as flat as possible in order for us to be able to quickly locate and identify what we need. Also, it recommends applying the "Don't Repeat Yourself" (DRY) principle and thus avoid duplicating information as much as possible.
