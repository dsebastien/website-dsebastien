...
The LIFT principle was introduced by Google as part of the [AngularJS](https://github.com/angular/angular.js) and [Angular](https://angular.io/) style guides. It is a code organization best practice for software developers. But in reality, this principle applies really well to [[Personal Knowledge Management (PKM)]] and [[Information Management (IM)]] in general.
