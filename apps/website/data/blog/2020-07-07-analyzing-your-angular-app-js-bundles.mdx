...
summary: 'How to analyze the JS bundles of your Angular applications and fix bundle size issues.'
...
keywords: [angular bundle size too big, angular bundle size, angular analyze bundle size]
published: true
---
