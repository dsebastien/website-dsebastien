...
image: '/static/images/logos/typescript.png'
...
<Image
  alt={`TypeScript`}
  src={`/static/images/logos/typescript.png`}
  width={400}
  height={400}
  priority
/>
...
After a bit of Googling around, I’ve stumbled upon [Greg Turnquist](https://twitter.com/gregturn)’s [blog posts about AsciiDoctor and Packt](http://greglturnquist.com/2015/02/24/how-to-create-your-own-openoffice/) (Greg [has published a few books with Packt](https://www.amazon.com/Greg-L.-Turnquist/e/B00Q23NAXI) — go check them out!), which led me to his open source project: [https://github.com/gregturn/asciidoctor-packt](https://github.com/gregturn/asciidoctor-packt)
