...
There's a hard limit to how productive we can be, and a necessity for us all to take better care of our health. More and more people end up burning out like candles. Out of energy, with a body that just says STOP.
...
André and I have been exploring productivity systems for years, but we don't have all the answers (far from it 😂). We are all unique, and so each and every single one of us needs specific solutions. Not generic ones.

We are eager to explore productivity further, and exchange ideas with other like-minded people. And what better way to do that than to create a community?

## Community
The focusd community is a place where we are able to share ideas, workflows, systems, tools, interesting articles, tips, tricks and hacks about Zen productivity.
