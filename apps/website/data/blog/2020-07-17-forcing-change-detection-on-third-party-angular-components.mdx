...
As I’ve [explained in my book](https://www.amazon.com/Learn-TypeScript-Building-Applications-understanding/dp/1789615860?tag=dsebastien-20), there’s a change detector tree parallel to the component tree, so each component actually has its own change detector attached.
