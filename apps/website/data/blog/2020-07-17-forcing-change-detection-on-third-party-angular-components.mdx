...
As I’ve [explained in my book](https://www.amazon.com/Learn-TypeScript-Building-Applications-understanding/dp/1789615860/), there’s a change detector tree parallel to the component tree, so each component actually has its own change detector attached.
