---
title: 'MoSCoW prioritization for daily todos'
summary: 'Extending the MoSCoW prioritization method to tag daily tasks'
...
To reach that goal, I’ve read quite a few interesting books, but the one that struck me the most was [Make Time](https://www.amazon.com/Make-Time-Focus-Matters-Every/dp/0525572422?tag=dsebastien00-20) by Jake Knapp & John Zeratsky, which I definitely recommend.
...
The MoSCoW prioritization method is quite simple. You just have to tag your tasks with a letter, indicating their importance:
...
Once you tag all your tasks with the MoSCoW method, you can then sort them by importance and focus on what really matters.

# Revisiting the MoSCoW method
Like most of us, I can almost never limit myself to a single task each day. My highlight is my center of attention, but quite a few additional tasks make it to my todo list each day. There are calls to make, appointments to go to, groceries to buy, etc.

Since I have a rather weak short term memory, I like to [think on paper](https://www.linkedin.com/pulse/5-reasons-thinking-paper-increase-productivity-adam-bensman/) and write down my todo list the day before, as part of [my evening routine](https://dsebastien.net/blog/2021-10-25-evening-routine).
...
Here’s the MoSCoW method variant that I use to tag my todo list items:
